						...
						else
						{
							$.ajax({
								...
								success: function(data) {
									...
									{
										//alert("Success");
										$(".alertMessage").html("<h4 style=\"color: green;\"> Reply posted successfully . </h4>");
										$(".AlertBox").show();
										setTimeout(function() {
											$(".AlertBox").hide();
										}, 4000);
									...
									{
										//alert("Failed");
										$(".alertMessage").html("<h4 style=\"color: red;\"> Reply Failed! Please try again or contact technical support if the problem continues. </h4>");
										$(".AlertBox").show();
										setTimeout(function() {
											$(".AlertBox").hide();
										}, 4000);
