	...
	while($row = mysql_fetch_array($results))
	{
		...
		echo '
			...
			<div id="inclusion_container" class="formDivBox">
				<span class="sub_headings1"> Unpaid caregiver for a person with dementia: </span><br/> <input type="radio" name="Caregiver" id="Caregiver" checked value="yes"> YES </input> <br/> <input type="radio" name="Caregiver" id="Caregiver" value="male"> NO </input><br/>
				
				<span class="sub_headings1"> Internet Access: </span>
				<br/>
					<input type="radio" name="Internet" id="Internet" checked  value="yes"> YES </input> <br/>
					<input type="radio" name="Internet" id="Internet" value="male"> NO </input><br/>
				<span class="sub_headings1"> Proficient in English: </span><br/>
					<input type="radio" name="English" id="English" checked value="yes"> YES </input><br/>
					<input type="radio" name="English" id="English" value="male"> NO </input><br/>
			</div>
			<span class="sub_headings1"> With Payment? </span>
			<div id="payment_div">
					<input type="radio" name="with_payment" checked value="YES"> YES </input><br/>
